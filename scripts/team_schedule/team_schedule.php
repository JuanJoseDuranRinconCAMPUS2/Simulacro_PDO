<?php
    ...
    class team_schedule extends connect{
        ...
        private $message;
        use getInstance;
        function __construct(private $id = 0, private $team_name = 1, private $check_in_skills = 1, private $check_out_skills = 1, private $check_in_soft = 1, private $check_out_soft = 1, private $check_in_english = 1, private $check_out_english = 1, private $check_in_review = 1, private $check_out_review = 1){parent::__construct();}
        public function postTeam_schedule(){
            try {
                ...
                $res->bindValue("ID_Journey", $this->getLastJourneyForeignKey());
                $res->execute();
